  ...
  return (
    <main className="relative min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] md:h-[80vh] w-full flex items-end">
        <Image
          src="https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=2574&auto=format&fit=crop" // Resort facade/dreamy view
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pb-16 md:pb-24">
          <div className="max-w-4xl">
            ...
            <p className="text-lg md:text-2xl text-white/90 font-light max-w-2xl leading-relaxed">
              A lakeside family dream turned into a destination
            </p>
          </div>
        </div>
      </section>{" "}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-serif text-gray-900 mb-8 font-medium">
              A Lakeside Dream That Became a Destination
            </h2>
            <div className="space-y-6 text-gray-600 text-lg md:text-xl font-light leading-relaxed">
              <p>
                Welcome to Malankara Palace Lake View Resort & Spa – a premium
                lakeside retreat created on the peaceful banks of the Malankara
                Reservoir. Surrounded by open water, green landscapes, and
                gentle hill views, the resort brings together scenic beauty,
                refined comfort, and warm hospitality in one setting.
              </p>
              <p>
                Located near Thodupuzha and within easy reach of Vagamon and
                Kochi International Airport, the property serves as a calm
                gateway to explore Idukki while enjoying a relaxed, luxury stay
                by the lake.
              </p>
            </div>
          </div>
          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div className="space-y-8 text-gray-600 text-lg md:text-xl font-light leading-relaxed">
              <p>
                ...
                waking up to lake breezes, spending quiet mornings by the water,
                enjoying evening sunsets, and gathering together under starlit
                skies.
              </p>
              <p>
              ...
              <p>
                ...
                <span className="italic font-medium text-gray-800">
                  what if this place could offer the same peace and happiness to
                  others?
                </span>{" "}
