  ...
  return (
    <main className="relative min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] md:h-[80vh] w-full flex items-end">
        <Image
          src="https://images.unsplash.com/photo-1544984243-ec57ea16fe25?q=80&w=2574&auto=format&fit=crop" // Resort pool/wedding venue view
          alt="Wedding and Events at Malankara Palace"
          fill
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pb-16 md:pb-24">
          <div className="max-w-4xl">
            ...
            <p className="text-lg md:text-2xl text-white/90 font-light max-w-2xl leading-relaxed">
              A serene lakeside venue for destination weddings, celebrations,
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-serif text-gray-500 mb-6 font-medium">
              Weddings & Events
            </h2>
            <h3 className="text-3xl md:text-4xl font-serif text-gray-900 mb-10 font-medium italic">
              Celebrate Life’s Most Important Moments by the Lake
            </h3>
            <div className="space-y-6 text-gray-600 text-[17px] md:text-lg font-light leading-relaxed">
              <p>
                Host your special occasions in a scenic lakeside setting where
                open skies, calm waters, and elegant spaces create a naturally
                memorable backdrop. From intimate wedding ceremonies to grand
                social celebrations and private gatherings, every event here is
                shaped with thoughtful planning and personalised attention.
              </p>
              <p>
                With flexible indoor and outdoor venues, custom décor options,
                and curated dining experiences, each celebration is designed to
                reflect your style while ensuring guest comfort and seamless
                coordination.
              </p>
            </div>
          </div>
      ...
      <section className="relative h-[300px] md:h-[400px] w-full overflow-hidden flex items-center justify-center">
        <div
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1511795409834-ef04bbd61622?q=80&w=2069&auto=format&fit=crop')`, // Wedding atmosphere
          }}
        >
        ...
        <div className="relative z-10 text-center px-4">
          <h2 className="text-4xl md:text-6xl font-serif text-white leading-tight">
            A celebration of love in <br /> nature’s paradise
          </h2>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-5xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-serif text-gray-900 mb-8 font-medium">
              A Setting Made for Celebrations
            </h2>
            <p className="text-gray-600 text-lg md:text-xl font-light leading-relaxed">
              Whether you envision a lakeside ceremony adorned with floral décor
              or an elegant indoor gathering with close family and friends, our
              venues provide the perfect backdrop for your special day.
              Surrounded by peaceful views and scenic natural beauty, every
              celebration feels elevated and memorable. We host a wide range of
              occasions including destination weddings, pre-wedding functions,
              haldi and engagement ceremonies, wedding receptions, and
              anniversary celebrations – each thoughtfully supported to ensure a
              seamless and meaningful event experience.
            </p>
          </div>
